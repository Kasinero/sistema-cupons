    ...
    <div class="container">
        ...
        <div style="background: #fff; padding: 30px; border-radius: 16px; box-shadow: var(--shadow); border: 2px solid var(--accent); margin-bottom: 40px;">
            ...
            <div class="cupom-grid">
                ...
                $sqlMeu = "SELECT c.tit_cupom, c.num_cupom, com.nom_fantasia_comercio, c.per_desc_cupom, c.dta_termino_cupom, r.dta_uso_cupom_associado 
                ...
                if(count($meus) > 0) {
                    foreach ($meus as $meu) {
                        ...
                        echo "<div class='cupom-body'><small>Código:</small><div class='cupom-code'>" . $meu['num_cupom'] . "</div>";
        ...
        <div class="cupom-grid">
            ...
            $sql .= " ORDER BY c.dta_emissao_cupom DESC LIMIT 20";
