...
<body style="background: linear-gradient(180deg, #f8f9fd 0%, #ffffff 100%);">
    ...
    <div class="nav" style="max-width: 1000px; margin: 20px auto; background: rgba(255,255,255,0.8); backdrop-filter: blur(10px);">
        ...
        <a href="views/login.php" style="color: var(--primary); font-weight: 600;">Área Restrita &rarr;</a>
    </div>

    <div class="hero">
        <h1>Descontos reais no seu comércio local</h1>
        <p>A plataforma que conecta moradores inteligentes a comércios que querem crescer. Simples, rápido e sem taxas.</p>
        
        <div class="btn-group">
            <a href="views/cadastro.php">
                <button>Quero Criar Conta</button>
            </a>
    ...
    <footer style="text-align: center; padding: 40px; color: var(--gray); font-size: 0.9rem;">
        &copy; 2025 Cupons Leila - Projeto de Engenharia de Software UNAERP
    </footer>
